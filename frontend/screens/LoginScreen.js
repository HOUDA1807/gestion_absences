...
const styles = StyleSheet.create({
  container: { flex: 1, justifyContent: 'center', padding: 20, backgroundColor: '#fff8dc' },
  title: { fontSize: 28, marginBottom: 20, textAlign: 'center', fontWeight: 'bold', color: '#d2b48c'},
  input: { borderWidth: 1, marginBottom: 10, padding: 10, borderRadius: 5, color: '#d2b48c' },
});
